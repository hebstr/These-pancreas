...
#| fig-cap: !expr .title_fig_surv_total$os
#| fig-height: 3.75
#| fig-width: 7
#| out-width: 100%

out_qmd(fig_surv_total$os)
```
...
#| fig-cap: !expr .title_fig_surv_strata$os
#| fig-height: 3.75
#| fig-width: 7
#| out-width: 100%

out_qmd(fig_surv_strata$os)
```
...
#| fig-cap: !expr .title_fig_surv_total$pfs
#| fig-height: 3.75
#| fig-width: 7
#| out-width: 100%

out_qmd(fig_surv_total$pfs)
```
...
#| fig-cap: !expr .title_fig_surv_strata$pfs
#| fig-height: 3.75
#| fig-width: 7
#| out-width: 100%

out_qmd(fig_surv_strata$pfs)
```
...
.pois_check_vif |> gt::gt() |> theme_gt()
```

1 = absence de corrélation ; < 5 = pas de collinéarité
...
.coxph_check_tbl$os |> gt::gt() |> theme_gt()
```
...
.coxph_check_tbl$pfs |> gt::gt() |> theme_gt()
```
...
sessioninfo::session_info(to_file = here::here(.log_dir, "session.txt"))
```

{{< script logs/session.txt >}}
